...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. REEMZAR is Official Size 7 with a 24 cm diameter — the same size used in professional and collegiate basketball. The weight is 320 g, optimized for indoor foam construction.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. The soft foam construction is gentle on hardwood, laminate, and tile — no scuff marks or damage from normal dribbling and handling.",
  },
  {
      ...
      <div className="container faq__inner">
        ...
        <div className="faq__list" role="list">
          {faqs.map((faq, index) => {
            ...
            return (
              <div key={faq.question} className="faq__item" role="listitem">
                <button
                  type="button"
